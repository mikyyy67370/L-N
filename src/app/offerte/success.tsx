          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-white rounded-2xl p-8 mb-12 shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                ...
                <a href="mailto:Inreinigunggmbh@gmail.com" className="flex items-center justify-center space-x-3 border-2 border-brand-gold text-brand-gold hover:bg-brand-gold hover:text-brand-dark-brown font-semibold font-lato px-6 py-3 rounded-full transition-all">
                  <Mail className="w-5 h-5" />
                                      <span>Inreinigunggmbh@gmail.com</span>
                </a>
              </div>
            </div>
