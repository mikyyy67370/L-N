...
export default function FurnitureCleaningPage() {
  ...
  const benefits = [
    {
      icon: Heart,
      title: 'Mehr Zeit für Familie',
      description: 'Verbringen Sie wertvolle Zeit mit Ihren Liebsten, statt mit Putzen.'
    },
    {
      icon: ShieldCheck,
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <nav className="flex items-center text-sm text-white/70 font-lato mb-8">
                ...
                <span className="mx-2">›</span>
                <span className="text-brand-gold">Nettoyage de meubles</span>
              </nav>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-playfair text-white mb-8 leading-tight">
                ...
                <span className="block text-brand-gold">expert</span>
              </h1>
